...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func handleShortcutItem(item: UIApplicationShortcutItem) -> Bool {
        ...
        case ShortcutIdentifier.First.type:
            reqVC = mainStoryboard.instantiateViewController(withIdentifier: "VC1") as! FirstViewController
            handled = true
            
        case ShortcutIdentifier.Second.type:
            reqVC = mainStoryboard.instantiateViewController(withIdentifier: "VC2") as! SecondViewController
            handled = true
