...
open class CocoaMQTTFrameBuffer: NSObject {
    ...
    //
    var isBufferEmpty: Bool { return buffer.count == 0 }
    var isBufferFull: Bool { return buffer.count > bufferSize }
    var isSilosFull: Bool { return silos.count >= Int(silosMaxNumber) }
