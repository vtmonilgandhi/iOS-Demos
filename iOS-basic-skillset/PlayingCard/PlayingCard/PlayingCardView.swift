...
class PlayingCardView: UIView {
    ...
    private lazy var upperLeftCornerLabel = createCorenerLabel()
    private lazy var lowerRightCornerLabel = createCorenerLabel()

    // setNeedsLayout() call this function
    ...
    // setNeedsDisplay() call this function
